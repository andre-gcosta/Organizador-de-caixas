...
GPIO.setup(12, GPIO.OUT)##c1
GPIO.setup(16, GPIO.OUT)##c2
GPIO.setup(18, GPIO.OUT)##c3
GPIO.setup(22, GPIO.OUT)##c4
GPIO.setup(8, GPIO.OUT)##m1
GPIO.setup(10, GPIO.OUT)##m2

GPIO.setup(11, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##s1
GPIO.setup(7, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##s2
GPIO.setup(23, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##s3
GPIO.setup(13, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##sc1
GPIO.setup(15, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##sc2
GPIO.setup(19, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##sc3
GPIO.setup(21, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##sc4
#GPIO.setup(31, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)##bot
...
GPIO.output(12, False)##|Cilindros
GPIO.output(16, False)##|
GPIO.output(18, False)##|
GPIO.output(22, False)##|

GPIO.output(8, False)##|Motores
...
while True:
    ...
    def prog():
        ...
        if (mod==2):
            ...
            if ((GPIO.input(11)==1) and (GPIO.input(7)==0) and (GPIO.input(23)==0) and (aux1==0)):##não metal baixa
                aux1=1
            if ((GPIO.input(11)==1) and (GPIO.input(7)==1) and (GPIO.input(23)==0) and (aux2==0)):##não metal alta
                aux2=1
            if ((GPIO.input(11)==1) and (GPIO.input(7)==0) and (GPIO.input(23)==1) and (aux3==0)):##metal baixa
                aux3=1
            if ((GPIO.input(11)==1) and (GPIO.input(7)==1) and (GPIO.input(23)==1) and (aux4==0)):##metal alta
                aux4=1
            if (GPIO.input(11)==0 and GPIO.input(7)==0 and GPIO.input(23)==0):
                ...
                if(aux4==1):
                    ...
                    if (ms==1):
                        mem=mem+4000000000
            if (GPIO.input(13)==1 and aux5==0):
                aux5=1
            if (GPIO.input(15)==1 and aux6==0):
                aux6=1
            if (GPIO.input(19)==1 and aux7==0):
                aux7=1
            if (GPIO.input(21)==1 and aux8==0):
                aux8=1
            if (GPIO.input(13)==0 and aux5==1 and t1==0):
                aux5=0
                if (mem==1):
                    mem=mem-1
                ...
                if (mem>=1000000000 and mem<=1999999999):
                    ...
                    #t1=1
                    timer1()
            if (GPIO.input(15)==0 and aux6==1 and t2==0):
                aux6=0
                if (mem==2):
                    mem=mem-2
                    mem=mem*10##correcao casas da memoria
                ...
                if (mem>=2000000000 and mem<=2999999999):
                    ...
                    #t2=1
                    timer2()
            if (GPIO.input(19)==0 and aux7==1 and t3==0):
                aux7=0
                if (mem==3):
                    mem=mem-3
                    mem=mem*10##correcao casas da memoria
                ...
                if (mem>=3000000000 and mem<=3999999999):
                    ...
                    #t3=1
                    timer3()
            if (GPIO.input(21)==0 and aux8==1 and t4==0):
                aux8=0
                if (mem==4):
                    mem=mem-4
                    mem=mem*10##correcao casas da memoria
        ...
        if (t4>=1):
            timer4()
        return()
    app.run(host='10.0.0.11', port=5000, debug=True)
